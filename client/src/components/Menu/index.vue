    ...
    <div class="inner">
      <el-menu
        ...
        <el-submenu index="3">
          ...
          <el-menu-item index="/b/report/effect-retention">留存分析</el-menu-item>
        </el-submenu>
        <el-submenu index="4">
          <template slot="title">
...
<script>
  export default {
    ...
    mounted() {
      // 解决element-ui 子菜单与主菜单缩进不一致
      let report_menu = document.getElementById('report_menu');
      let itemList = report_menu.getElementsByClassName('el-menu-item');
